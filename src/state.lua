...
local state = {
	...
	fontDefs = {
		header = { name = "Inter", path = "assets_app/fonts/inter/Inter_24pt-SemiBold.ttf", size = 32 },
		body = { name = "Inter", path = "assets_app/fonts/inter/Inter_24pt-SemiBold.ttf", size = 24 },
		bodyBold = { name = "Inter", path = "assets_app/fonts/inter/Inter_24pt-Black.ttf", size = 24 },
		caption = { name = "Inter", path = "assets_app/fonts/inter/Inter_24pt-SemiBold.ttf", size = 20 },
		monoTitle = { name = "Cascadia Code", path = "assets_app/fonts/cascadia_code/CascadiaCode-Bold.ttf", size = 48 },
		monoBody = { name = "Cascadia Code", path = "assets_app/fonts/cascadia_code/CascadiaCode-Bold.ttf", size = 22 },
		nunito = { name = "Nunito", path = "assets_app/fonts/nunito/Nunito-Bold.ttf", size = 24 },
		retroPixel = { name = "Retro Pixel", path = "assets_app/fonts/retro_pixel/retro-pixel-thick.ttf", size = 24 },
	},
